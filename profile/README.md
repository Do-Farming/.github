...
| 회원가입 | 로그인 |
|:--------------------------------------------------:|:--------------------------------------------------:|
| <img src="https://github.com/user-attachments/assets/9b41c00c-4470-4a06-b961-383565cea040" width="240" height="520"> | <img src="https://github.com/user-attachments/assets/57144a32-3237-4320-b153-85708f8543f3" width="240" height="520"> |
| ✔️ 휴대폰 인증을 통해 본인확인을 진행합니다. | ✔️ 인증받은 휴대폰 번호와 비밀번호로 로그인합니다. |
<br/>

### ➋ 이체
| <img src="https://github.com/user-attachments/assets/10dec370-669f-46d2-a31f-4a2ebdd96785" width="240" height="520"> |
|:--------------------------------------------------:|
| ✔️ 로그인 후, 이체가 가능합니다.<br/>✔️ 거래 내역 조회를 통해 거래 내역을 확인할 수 있습니다.|
<br/>

### ➌ 도파밍 상품 서비스 이용하기
| 도파밍 상품 가입 - 방 생성 | 도파밍 상품 가입 - 방 입장 |
|:--------------------------------------------------:|:--------------------------------------------------:|
| <img src="https://github.com/user-attachments/assets/154c6bb9-d789-4cd7-a73a-91b7d90985f4" width="240" height="520"> | <img src="https://github.com/user-attachments/assets/c3757e75-ec7a-4438-8250-e52dd452ccb0" width="240" height="520"> |
| ✔️ 도파밍 그룹 방을 직접 생성하고 도파밍 상품에 가입합니다.<br/>✔️ 카카오톡으로 공유가 가능합니다. | ✔️ 존재하는 도파밍 그룹 방에 가입하여 도파밍 상품에 가입합니다.<br/>✔️ 도파밍 상품에 가입 시 예금 통장에서 돈을 이체합니다. |
<br/>

| 기상 챌린지 수행 |
|:--------------------------------------------------:|
| <img src="https://github.com/user-attachments/assets/3452335e-d334-4f6f-9320-143133a5ca1b" width="240" height="520"> |
| ✔️ 알람이 오면, 랜덤으로 제시되는 아이템의 사진을 촬영하여 기상 인증을 완료합니다.<br/>✔️ 기상 인증을 빠르게 완료한 참여자가 높은 순위를 얻게 됩니다.|
<br/>
...
| 만보기 챌린지 수행 |
|:--------------------------------------------------:|
| <img src="https://github.com/user-attachments/assets/25b3e736-7e0b-4ea6-a441-6629f0767390" width="240" height="520"> |
| ✔️ 챌린지 수행 중 실시간으로 걸음 수가 갱신됩니다.<br/>✔️ 걸음 수가 높을수록 순위가 올라갑니다.|
<br/>
